...
def geta(request: GetRequest):
    ...
    if request.local_path:
        command.append(request.local_path)
...
def put_upload(file: UploadFile = File(...), destination_path: str = "/"):
    """
    Upload a file to reMarkable device via file upload.
    ...
    try:
        ...
        command = ["put", str(temp_file_path), destination_path]
